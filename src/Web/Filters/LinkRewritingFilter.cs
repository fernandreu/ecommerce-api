...
using ECommerceAPI.ApplicationCore.Extensions;
...
{
    /// <summary>
    /// This filter will take care of showing accurate links to all resources.
    /// Concept taken from REST API course by Nate Barbettini.
    /// </summary>
